  ...
  const fetchDashboardData = async () => {
    try {
      ...
      setDashboardData({
        ...
        vehicles: vehiclesRes.status === 'fulfilled' ? (Array.isArray(vehiclesRes.value) ? vehiclesRes.value : (vehiclesRes.value?.data || [])) : [],
        notifications: notificationsRes.status === 'fulfilled' ? (Array.isArray(notificationsRes.value) ? notificationsRes.value : (notificationsRes.value?.data || [])) : [],
